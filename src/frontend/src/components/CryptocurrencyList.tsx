    ...
    return (
      <div className="space-y-4">
        ...
        <div className="bg-dark-surface rounded-2xl border-3 border-gray-500 p-4 sm:p-6 text-center">
          <AlertCircleIcon
            size={32}
            className="text-dark-warning mx-auto mb-4"
          />
          <p className="text-dark-text font-bold mb-2 global-font mobile-text-base">
            暂无交易对配置
          </p>
            ...
            >
              ...
              <div className="block sm:hidden space-y-2">
                ...
                <div className="flex items-center justify-between pl-8">
                  <div>
                    <div
                      className={`font-bold elegant-numbers global-font mobile-text-sm ${
              ...
              <div className="hidden sm:grid grid-cols-12 gap-4 items-center">
                ...
                <div className="col-span-4">
                  <div
                    className={`font-bold elegant-numbers global-font ${
                      crypto.currentPrice !== null
                        ? "text-dark-text"
                        : "text-dark-text-secondary"
                    }`}
