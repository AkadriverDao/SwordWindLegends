...
export default function BlogCustomizationPage({
  navigate,
}: BlogCustomizationPageProps) {
  ...
  const currentTheme =
    THEME_COLORS.find((t) => t.value === tempCustomization.themeColor) ||
    THEME_COLORS[0];
  const currentFont =
    FONT_STYLES.find((f) => f.value === tempCustomization.fontStyle) ||
    FONT_STYLES[0];
  ...
  const currentAccent =
    ACCENT_COLORS.find((a) => a.value === tempCustomization.accentColor) ||
    ACCENT_COLORS[0];
            ...
            <div className="p-8 space-y-8">
              ...
              <div className="space-y-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleTempUpdate({ blogTitle: e.target.value })
                  }
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {THEME_COLORS.map((theme) => (
                    <button
                      ...
                      key={theme.value}
                      onClick={() =>
                        handleTempUpdate({ themeColor: theme.value })
                      }
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {FONT_STYLES.map((font) => (
                    <button
                      ...
                      key={font.value}
                      onClick={() =>
                        handleTempUpdate({ fontStyle: font.value })
                      }
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {BACKGROUND_STYLES.map((bg) => (
                    <button
                      ...
                      key={bg.value}
                      onClick={() =>
                        handleTempUpdate({ backgroundStyle: bg.value })
                      }
                ...
                <div className="flex flex-wrap gap-3">
                  {ACCENT_COLORS.map((accent) => (
                    <button
                      ...
                      key={accent.value}
                      onClick={() =>
                        handleTempUpdate({ accentColor: accent.value })
                      }
