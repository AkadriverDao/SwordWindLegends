...
export default function MiningInterface({
  ...
  const handleOccupyAndMine = async () => {
    ...
    try {
      ...
      setOperationError(
        error instanceof Error ? error.message : "占领失败，请重试",
      );
    } finally {
      ...
      <div className="mb-6">
        ...
        >
          <div className="flex items-center space-x-2">
            ...
            <div>
              <p
                className={`font-bold global-font ${
                  isAvailable
                    ? "text-green-500"
                    : isOwned
                      ? "text-blue-500"
      ...
      <div className="space-y-4">
        {isAvailable && (
          <button
            ...
            type="button"
            title={
              !isCharacterAlive ? "角色死亡，无法挖矿" : "占领土地并开始挖矿"
            }
          >
            {isOccupying ? (
              <>
        ...
        {isOwned && (
          <div className="bg-blue-500/20 border-2 border-blue-500 rounded-xl p-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-blue-500 font-bold global-font">
                  您已拥有此土地
                </p>
                <p className="text-dark-text-secondary text-sm global-font">
                  {!isCharacterAlive
        ...
        {isOccupied && (
          <div className="bg-red-500/20 border-2 border-red-500 rounded-xl p-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-red-500 font-bold global-font">
                  土地已被占领
                </p>
                <p className="text-dark-text-secondary text-sm global-font">
