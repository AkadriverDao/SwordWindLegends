...
export default function UserGameStatus({
  gameState,
  isLoading,
  miningCountdown,
  onReviveCharacter,
  ...
  const handleReviveCharacter = async () => {
    if (!onReviveCharacter || !gameState || gameState.isAlive || isReviving)
      return;
  ...
  if (!gameState) {
    return (
      <div className="bg-dark-surface rounded-2xl border-3 border-gray-500 p-6 text-center">
        ...
        <p className="text-dark-text font-bold global-font mb-2">
          开始您的挖矿之旅
        </p>
  ...
  return (
    <div className="bg-dark-surface rounded-2xl border-3 border-gray-500 p-6">
      ...
      {gameState.isMining &&
        miningCountdown !== null &&
        miningCountdown !== undefined && (
      ...
      >
        <div className="flex items-center space-x-3">
          ...
          <div>
            <p
              className={`font-bold global-font ${gameState.isAlive ? "text-green-500" : "text-red-500"}`}
            >
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-dark-card rounded-xl p-4 border-2 border-gray-500">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className="text-dark-text font-bold text-sm global-font">
                金币
              </span>
            </div>
      ...
      {gameState.isAlive && gameState.ownedLands.length > 0 && (
        <div className="mt-6">
          <h4 className="text-md font-bold text-dark-text global-font mb-3">
            🏠 我的土地
          </h4>
