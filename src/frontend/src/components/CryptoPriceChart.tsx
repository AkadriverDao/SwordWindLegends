...
import ChartInteractions, {
  type HoveredPoint,
} from "./crypto/ChartInteractions";
import { ChartRenderer } from "./crypto/ChartRenderer";
import ChartStatusIndicator, {
  ChartTooltip,
} from "./crypto/ChartStatusIndicator";
import {
  calculatePriceChange,
  formatPrice,
  formatPriceChange,
  validatePriceData,
} from "./crypto/DataProcessor";
import ErrorHandler, {
  LoadingState,
  ErrorBoundary,
} from "./crypto/ErrorHandler";
import PriceDataFetcher, {
  type PriceDataState,
} from "./crypto/PriceDataFetcher";
...
export default function CryptoPriceChart({
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: selectedTradingPair is a prop that changes
  React.useEffect(() => {
