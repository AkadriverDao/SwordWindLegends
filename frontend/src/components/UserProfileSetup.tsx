    ...
    <div className="max-w-md mx-auto">
      <div className="bg-dark-card backdrop-blur-sm rounded-3xl shadow-2xl p-12 border-4 border-dark-accent">
        <div className="text-center mb-8">
          ...
          <p className="text-dark-text-secondary text-lg font-medium">请输入您的信息以开始使用</p>
        </div>
        
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label htmlFor="name" className="flex items-center text-lg font-bold text-dark-text mb-3">
              👤 姓名
            </label>
            <input
              type="text"
          ...
          <div className="bg-dark-primary/20 rounded-xl p-4 border-2 border-dark-primary/30">
            <p className="text-dark-primary text-sm font-medium flex items-center">
              💡 <span className="ml-2">博客标题默认为"Sword Wind Legends"，您可以在个人页面中进行自定义设置</span>
            </p>
          </div>
