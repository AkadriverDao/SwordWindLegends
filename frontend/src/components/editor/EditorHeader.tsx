...
import { ArrowLeftIcon, EyeIcon, EditIcon } from 'lucide-react';
...
export default function EditorHeader({ isEditing, isPreviewMode, onClose, onTogglePreview }: EditorHeaderProps) {
  return (
