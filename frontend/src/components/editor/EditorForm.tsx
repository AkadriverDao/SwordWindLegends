...
export default function EditorForm({ 
  ...
  return (
    <form onSubmit={onSubmit} className="p-8 space-y-6">
      <div>
        <label htmlFor="title" className="flex items-center text-lg font-bold text-dark-text mb-3">
          📝 标题
        </label>
        <input
          type="text"
      ...
      <div>
        <label htmlFor="content" className="flex items-center text-lg font-bold text-dark-text mb-3">
          📖 内容
        </label>
        {children}
      </div>
