...
export default function UserInfoEditModal({ userProfile, onClose }: UserInfoEditModalProps) {
      ...
      <div className="bg-dark-card backdrop-blur-sm rounded-3xl shadow-2xl border-4 border-dark-accent w-full max-w-md">
        ...
        <div className="p-6 border-b-4 border-dark-border bg-gradient-to-r from-dark-surface to-dark-muted rounded-t-3xl">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-xl font-bold text-dark-text">✏️ 编辑用户信息</h3>
                <p className="text-dark-text-secondary font-medium">修改您的个人资料</p>
              </div>
            </div>
            <button
              onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div className="space-y-3">
            <label className="flex items-center text-lg font-bold text-dark-text">
              ✨ 用户名称
            </label>
            <input
              type="text"
