...
import { ArrowLeftIcon, ArrowRightLeftIcon, CoinsIcon, AlertTriangleIcon, CheckCircleIcon, ClockIcon, XCircleIcon } from 'lucide-react';
...
import { useGetExchangeRate, useGetExchangeHistory, useExchangeGoldForICP } from '../hooks/useGoldExchangeQueries';
...
export default function GoldExchangePage({ navigate }: GoldExchangePageProps) {
  ...
  const handleExchange = async () => {
    const goldAmount = parseInt(exchangeAmount);
    ...
    conditionalLog('GoldExchangePage: 开始兑换', { goldAmount, icpAmount: calculateICPAmount(goldAmount) });
    setExchangeError(null);
    setExchangeSuccess(null);
    ...
    try {
      ...
      setExchangeError(error instanceof Error ? error.message : '兑换失败，请重试');
    }
  };
          ...
          <div className="p-6 border-b-4 border-gray-500 bg-gradient-to-r from-dark-surface to-dark-muted rounded-t-3xl">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-dark-text-secondary font-medium global-font">将挖矿金币兑换成ICP代币</p>
              </div>
            </div>
          </div>
        ...
        <div className="p-8 space-y-8">
          ...
          {exchangeSuccess && (
            <div className="bg-green-500/20 border-2 border-green-500 rounded-2xl p-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-green-500 font-bold text-lg global-font">🎉 兑换成功！</p>
                  <p className="text-dark-text-secondary global-font">{exchangeSuccess}</p>
                </div>
              </div>
            </div>
          )}
          ...
          {exchangeError && (
            <div className="bg-red-500/20 border-2 border-red-500 rounded-2xl p-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-red-500 font-bold text-lg global-font">⚠️ 兑换失败</p>
                  <p className="text-dark-text-secondary global-font">{exchangeError}</p>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="bg-dark-surface rounded-2xl border-3 border-gray-500 p-6">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-dark-text global-font">💱 金币兑换</h3>
            ...
            <div className="space-y-6">
              ...
              {exchangeAmount && parseInt(exchangeAmount) > 0 && (
                <div className="bg-dark-card rounded-xl p-4 border-2 border-gray-500">
                  ...
                  <div className="grid grid-cols-3 gap-4 items-center">
                    ...
                    <div className="text-center">
                      <ArrowRightLeftIcon size={20} className="text-green-500 mx-auto" />
                    </div>
                    <div className="text-center">
                      <div className="text-xl font-bold text-blue-500 elegant-numbers">
                        {calculateICPAmount(parseInt(exchangeAmount)).toFixed(4)}
                      </div>
                      <div className="text-xs text-dark-text-secondary global-font">
                        ICP
                      </div>
              ...
              <button
                ...
                disabled={
                  ...
                  parseInt(exchangeAmount) > currentGoldBalance ||
                  parseInt(exchangeAmount) < currentExchangeRate
                }
          ...
          <div className="bg-dark-surface rounded-2xl border-3 border-gray-500 p-6">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-dark-text global-font">📋 兑换历史</h3>
                <p className="text-dark-text-secondary text-sm global-font">
                  查看您的金币兑换记录和状态
                </p>
              </div>
            ...
            {historyLoading ? (
              <div className="text-center py-8">
                ...
                <p className="text-dark-text-secondary global-font">加载兑换历史中...</p>
              </div>
            ) : exchangeHistory && exchangeHistory.length > 0 ? (
              <div className="space-y-4">
                {exchangeHistory.map((record) => (
                  <div key={record.exchangeId} className="bg-dark-card rounded-xl p-4 border-2 border-gray-500">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        <div className="w-12 h-12 bg-gradient-to-r from-green-500 to-blue-500 rounded-full flex items-center justify-center shadow-lg">
                          <ArrowRightLeftIcon size={20} className="text-white" />
                        ...
                        <div>
                          <div className="flex items-center space-x-3 mb-1">
                            ...
                            <div className="flex items-center space-x-1">
                              ...
                              <span className={`text-sm font-bold global-font ${getStatusColor(record.status)}`}>
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-xs text-dark-text-secondary global-font">
                          {record.status === 'completed' ? '已到账' : record.status === 'pending' ? '处理中' : '失败'}
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <h5 className="font-bold text-dark-text global-font">兑换规则：</h5>
                  ...
                  <div className="space-y-2">
                    <h5 className="font-bold text-dark-text global-font">注意事项：</h5>
                    <ul className="text-dark-text-secondary text-sm global-font space-y-1">
