...
export interface _SERVICE {
  ...
  'addGameMod' : ActorMethod<[string, string, string, string], bigint>,
  ...
  'getAllGameMods' : ActorMethod<[], Array<[bigint, GameMod]>>,
  ...
  'getGameModById' : ActorMethod<[bigint], [] | [GameMod]>,
